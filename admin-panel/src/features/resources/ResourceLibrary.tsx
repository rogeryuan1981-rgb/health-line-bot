...
export default function ResourceLibrary() {
  ...
  const filteredResources = resources.filter(res => {
      ...
      const t = res.type || 'image'; 
      return t === listFilter;
  });

  return (
    // 👉 修正 1：加入 w-full h-full overflow-y-auto 與底部 padding，強制開啟獨立捲軸
    <div className="w-full h-full overflow-y-auto scrollbar-hide bg-[#0F172A]">
      <div className="p-8 max-w-5xl mx-auto text-white font-sans pb-32">
